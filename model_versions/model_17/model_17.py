...
def write_output_to_file(topic, outline, generated_text_draft, evaluations_draft, average_score, scored_outlines):
    # Create a unique file name
    timestamp = datetime.now().strftime("%Y-%m-%d-%H-%M-%S")
    filename = f"generated_text_{timestamp}.txt"
    filepath = "./code/outputs/model_17/" + filename
...
write_output_to_file(topic, outline, generated_text_draft, evaluations_draft, average_score, scored_outlines)
